- Filename: eccouncil-ceh31250-v10-18-1-1-iot-concepts
- Show Name: CEHv10 (312-50)
- Topic Name: IoT Hacking
- Episode Name: IoT Concepts
...
3. Consider writing application to allow local access only (no web access)
	...
	file-sharing reputation on a torrent network) is tricked into thinking that
	an attacking computer has a disproportionally large influence.
